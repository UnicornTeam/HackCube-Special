...
/*
 *  Decodeer kaartnummergegevens door de OUT-uitgangspen van de EM4095 te pollen
*/
...
/*
 *  Simuleer de werking van de kaart door de EM4095 MOD pin analoge kaartkoppeling te regelen
 */
...
/*
 *  Bestuurt de EM4095 SHD- en MOD-pinnen om ze in slaapstand te brengen voor een laag stroomverbruik
 */
...
/*
 * Simuleer / vernietig kaarten uit de EM4100-serie volgens de instructies
 */
void AttackEM4100(){
    while (NFC_action) {
    switch (NFC_action) {
