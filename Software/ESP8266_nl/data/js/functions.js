...
function rf_blast_post() {
    $.ajax({
        type: "POST",//Soort methode
        dataType: "json",//Het type gegevens dat door de server wordt verwacht
        url: "/rf_blast_c2" ,//url
        data: $('#rf_blast').serialize(),
        success: function (result) {
            console.log(result);//Druk de gegevens af die door de server zijn geretourneerd (voor foutopsporing))
